...
public class IntegrationTestProductAdvertisementService_removeBusinessAdvertisements {
	...
	@Test public void test_removeBusinessAdvertisements_0_0() {
		...
		try {
			arg2.removeBusinessAdvertisements(arg1);
	...
	@Test public void test_removeBusinessAdvertisements_0_57() {
		MongoCollection arg0 = mongoDatabase.getCollection("product_advertisement",ProductAdvertisement.class);
		...
		arg3.put("businessName", "DummyString#119");
		...
		arg6.put("advertisementPostText", "DummyString#148");
		arg6.put("associatedInfluencerName", "DummyString#149");
		Document arg7 = new Document();
		arg7.put("addressCity", "DummyString#150");
		arg7.put("addressStreet", "DummyString#151");
		Document arg8 = new Document();
		arg8.put("address", arg7);
		arg8.put("businessName", "DummyString#152");
		Document arg9 = new Document();
		arg9.put("category", 0);
		arg9.put("ownerBusiness", arg8);
		arg9.put("price", 0);
		arg9.put("productName", "DummyString#153");
	...
	@Test public void test_removeBusinessAdvertisements_0_84() {
		MongoCollection arg0 = mongoDatabase.getCollection("product_advertisement",ProductAdvertisement.class);
		Document arg1 = new Document();
		arg1.put("advertisementPostText", "DummyString#115");
		arg1.put("associatedInfluencerName", "DummyString#116");
		...
		Document arg3 = new Document();
		arg3.put("address", arg2);
		arg3.put("businessName", "thisBusiness");
		Document arg4 = new Document();
		arg4.put("category", 0);
		arg4.put("ownerBusiness", arg3);
		arg4.put("price", 0);
		...
		Document arg8 = new Document();
		arg8.put("address", arg7);
		arg8.put("businessName", "thisBusiness");
		Document arg9 = new Document();
		arg9.put("category", 0);
		arg9.put("ownerBusiness", arg8);
		arg9.put("price", 0);
		...
		Document arg13 = new Document();
		arg13.put("address", arg12);
		arg13.put("businessName", "thisBusiness");
		Document arg14 = new Document();
		arg14.put("category", 0);
		arg14.put("ownerBusiness", arg13);
		arg14.put("price", 0);
		...
		arg17.setProductAdvertisementCollection(arg0);
		// Generate assertEquals for method call
		assertEquals(3,arg17.removeBusinessAdvertisements(arg16));
		// Generate assertion statements to check content of 'product_advertisement':
		MongoCollection<Document> arg18 = mongoDatabase.getCollection("product_advertisement", Document.class);
		assertEquals(0,arg18.countDocuments());
	}
}