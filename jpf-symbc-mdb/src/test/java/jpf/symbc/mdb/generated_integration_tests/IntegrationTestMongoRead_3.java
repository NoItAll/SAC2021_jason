...
public class IntegrationTestMongoRead_3 {
	...
	@Test public void test_readCustomersUsingNeFilters_0_0() {
		MongoCollection arg0 = mongoDatabase.getCollection("custs",Customer.class);
		// Generate assertEquals for method call
		assertEquals(1,scenarios_crud.MongoRead_3.readCustomersUsingNeFilters(arg0));
	...
	@Test public void test_readCustomersUsingNeFilters_0_38() {
		MongoCollection arg0 = mongoDatabase.getCollection("custs",Customer.class);
		...
		arg0.insertOne(arg6);
		// Generate assertEquals for method call
		assertEquals(3,scenarios_crud.MongoRead_3.readCustomersUsingNeFilters(arg0));
		// Generate assertion statements to check content of 'custs':
	...
	@Test public void test_readCustomersUsingNeFilters_0_39() {
		MongoCollection arg0 = mongoDatabase.getCollection("custs",Customer.class);
		Document arg1 = new Document();
		arg1.put("_id", "DummyString#0");
		Document arg2 = new Document();
