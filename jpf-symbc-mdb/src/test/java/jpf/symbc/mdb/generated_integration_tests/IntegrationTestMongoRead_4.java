...
public class IntegrationTestMongoRead_4 {
	...
	@Test public void test_readCustomersUsingGTEFilters_0_0() {
		MongoCollection arg0 = mongoDatabase.getCollection("custs",Customer.class);
		// Generate assertEquals for method call
		assertEquals(1.0,scenarios_crud.MongoRead_4.readCustomersUsingGTEFilters(arg0),10e-6);
	...
	@Test public void test_readCustomersUsingGTEFilters_0_21() {
		MongoCollection arg0 = mongoDatabase.getCollection("custs",Customer.class);
		...
		arg3.put("_id", "DummyString#10");
		Document arg4 = new Document();
		arg4.put("_id", "DummyString#11");
		arg4.put("enlistedBy", arg3);
		arg4.put("income", 0.0);
		arg4.put("status", 14);
		arg0.insertOne(arg4);
		Document arg5 = new Document();
		arg5.put("_id", "DummyString#14");
		Document arg6 = new Document();
		arg6.put("_id", "DummyString#15");
		arg6.put("enlistedBy", arg5);
		arg6.put("income", 0.0);
		arg6.put("status", 14);
		arg0.insertOne(arg6);
		// Generate assertEquals for method call
		assertEquals(0.0,scenarios_crud.MongoRead_4.readCustomersUsingGTEFilters(arg0),10e-6);
		// Generate assertion statements to check content of 'custs':
	...
	@Test public void test_readCustomersUsingGTEFilters_0_38() {
		MongoCollection arg0 = mongoDatabase.getCollection("custs",Customer.class);
		Document arg1 = new Document();
		arg1.put("_id", "DummyString#0");
		Document arg2 = new Document();
