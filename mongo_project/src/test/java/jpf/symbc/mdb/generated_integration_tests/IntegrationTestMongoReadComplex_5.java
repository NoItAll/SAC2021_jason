...
public class IntegrationTestMongoReadComplex_5 {
	...
	@Test public void test_readOrdersWithLTFilter_0_0() {
		MongoCollection arg0 = mongoDatabase.getCollection("orders",Order.class);
		// Generate assertEquals for method call
		assertEquals(null,scenarios_crud.MongoReadComplex_5.readOrdersWithLTFilter(arg0));
