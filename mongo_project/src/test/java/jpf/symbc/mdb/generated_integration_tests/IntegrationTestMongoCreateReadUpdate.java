...
public class IntegrationTestMongoCreateReadUpdate {
	...
	@Test public void test_updateDocuments_0_0() {
		MongoCollection arg0 = mongoDatabase.getCollection("orders",Document.class);
		// Generate assertEquals for method call
		assertEquals(0,scenarios_crud.MongoCreateReadUpdate.updateDocuments(arg0));
	...
	@Test public void test_updateDocuments_0_14() {
		MongoCollection arg0 = mongoDatabase.getCollection("orders",Document.class);
		...
		arg15.put("income", 0.0);
		arg15.put("status", 0);
		arg15.put("income2", 13.9);
		...
		arg19.put("income", 0.0);
		arg19.put("status", 0);
		arg19.put("income2", 13.9);
		...
		arg23.put("income", 0.0);
		arg23.put("status", 0);
		arg23.put("income2", 13.9);
