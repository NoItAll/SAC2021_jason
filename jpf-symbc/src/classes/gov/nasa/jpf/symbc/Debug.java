...
public class Debug {
    ...
    native public static boolean isSymbolicReal(double v); // 15-05-2020 Added: Hendrik Winkelmann
    native public static boolean isSymbolicBoolean(boolean b); // 22-05-2020 Added: Hendrik Winkelmann
