...
public class GETSTATIC extends gov.nasa.jpf.jvm.bytecode.GETSTATIC {
	...
	public Instruction execute (ThreadInfo ti) {
		...
		// 23-04-2020 Added more information to "lazy initialization": Hendrik Winkelmann
		if (SymbolicInstructionFactory.debugMode && !ti.isFirstStepInsn())
			System.out.println("lazy init of static field, fieldname: " + fi.getName() + ", at: " +
					  mi.getClassName() + "." + mi.getLongName());
