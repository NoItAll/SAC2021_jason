...
//	public static double MAXDOUBLE = 10000.0;// 1.0e8; //Double.MAX_VALUE;
	...
	// 03-05-2020 Added StringSymbolic and ArrayExpression to the UniqueId: Hendrik Winkelmann
	public static int UniqueId = 0; // Unique id for each SymbolicInteger, ArrayExpression, StringSymbolic or
