...
public class IntegerConstant extends LinearIntegerExpression {
  ...
  // Introduced name-variable: Hendrik Winkelmann
  protected String name;
  
  public IntegerConstant (long i) {
	  value = i;
	  name = "CONST_" + value + ""; // Hendrik Winkelmann: Added name-attribute
	  // 28-04-2020 Added IntegerConstant-debugging: Hendrik Winkelmann
	  if (SymbolicInstructionFactory.debugMode)
			System.out.println("New constant integer " + name);
  }
  
  // 28-04-2020 Added IntegerConstant-constructor
  public IntegerConstant(long i, String typeName) {
	  this.value = i;
	  name = typeName + "-CONST_" + value + "";
  }
  ...
  public String stringPC () {
    return name; // Changed to name: Hendrik Winkelmann
  }
