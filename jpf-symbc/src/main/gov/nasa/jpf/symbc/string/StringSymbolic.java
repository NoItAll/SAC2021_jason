...
public class StringSymbolic extends StringExpression {
  ...
  // 04-05-2020 Added to make consistent with other "leaf"-expressions: Hendrik Winkelmann
  protected int unique_id;
	
	/* 04-05-2020 Added unique_id to facilitate access to symbolic variables: Hendrik Winkelmann */
  ...
  // Added unique_id-getter:Hendrik Winkelmann
